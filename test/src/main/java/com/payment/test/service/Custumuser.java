...
//bazadan user malumotlarini olish uchun
@Component
public class Custumuser implements UserDetailsService  {
    private final UserEntityRepository userEntityRepository;

    public Custumuser(UserEntityRepository userEntityRepository) {
